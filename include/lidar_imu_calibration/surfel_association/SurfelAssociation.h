...
#ifndef LIDAR_IMU_CALIBRATION_SURFELASSOCIATION_H
#define LIDAR_IMU_CALIBRATION_SURFELASSOCIATION_H
...
public:
  ...
  void saveSurfelsMap(const std::string & path) const
  {
...
private:
  ...
  static double point2PlaneDistance(const Eigen::Vector3d & pt,
...
#endif  // LIDAR_IMU_CALIBRATION_SURFELASSOCIATION_H
