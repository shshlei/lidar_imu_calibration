...
#ifndef LIDAR_IMU_CALIBRATION_POSE_H
#define LIDAR_IMU_CALIBRATION_POSE_H

#include "lidar_imu_calibration/types/Quat.h"
...
public:
  ...
  void update(const Eigen::VectorXd dx) override
  {
    ...
    // Update orientation
    newX.block(0, 0, 4, 1) = lidar_imu_calibration::quat_multiply(dq, quat());
...
#endif  // LIDAR_IMU_CALIBRATION_POSE_H
