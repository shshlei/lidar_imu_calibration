...
#ifndef LIDAR_IMU_CALIBRATION_EIGEN_UTILS_H
#define LIDAR_IMU_CALIBRATION_EIGEN_UTILS_H
...
template <typename K, typename V>
using aligned_unordered_map = std::unordered_map<K, V, std::hash<K>, std::equal_to<K>, Eigen::aligned_allocator<std::pair<K const, V>>>;
 ...
 */
inline void sort_vec(const Eigen::Vector3d & vec, Eigen::Vector3d & sorted_vec, Eigen::Vector3i & ind)
{
...
#endif  // LIDAR_IMU_CALIBRATION_EIGEN_UTILS_H
