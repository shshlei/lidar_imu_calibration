...
{
void UpdaterLidarOdometry::updateScan2Scan(State * current_state, const relativePose & lodom, bool & did_update)
{
  /// Li_T_Lj
...
void UpdaterLidarOdometry::updateScan2GlobalMap(State * current_state, const Eigen::Matrix4d & L1_T_Lk, const Eigen::Matrix4d & G_T_I1,
