...
lincalibManagerOptions parse_ros_nodehandler(ros::NodeHandle & nh)
{
  ...
  nh.param<bool>("calib_lidar_timeoffset", params.state_options.do_calib_lidar_imu_timeoffset, params.state_options.do_calib_lidar_imu_timeoffset);
  nh.param<int>("max_clones", params.state_options.max_clone_size, params.state_options.max_clone_size);
  nh.param<bool>("calib_extrinsics", params.state_options.do_calib_lidar_imu_extrinsic, params.state_options.do_calib_lidar_imu_extrinsic);
  nh.param<double>("state_init_x_noise", params.state_options.trans_x_noise_lidarimu, params.state_options.trans_x_noise_lidarimu);
  nh.param<double>("state_init_y_noise", params.state_options.trans_y_noise_lidarimu, params.state_options.trans_y_noise_lidarimu);
  nh.param<double>("state_init_z_noise", params.state_options.trans_z_noise_lidarimu, params.state_options.trans_z_noise_lidarimu);
  nh.param<double>("state_init_rx_noise", params.state_options.rot_x_noise_lidarimu, params.state_options.rot_x_noise_lidarimu);
  nh.param<double>("state_init_ry_noise", params.state_options.rot_y_noise_lidarimu, params.state_options.rot_y_noise_lidarimu);
  nh.param<double>("state_init_rz_noise", params.state_options.rot_z_noise_lidarimu, params.state_options.rot_z_noise_lidarimu);
  nh.param<double>("state_init_timeoffset_noise", params.state_options.time_offset_noise_lidarimu, params.state_options.time_offset_noise_lidarimu);
  ...
  nh.param("lidar_inertial_calib_extrinsic_filename", params.lidar_inertial_calib_extrinsic_filename, params.lidar_inertial_calib_extrinsic_filename);
  nh.param("lidar_inertial_calib_dt_filename", params.lidar_inertial_calib_dt_filename, params.lidar_inertial_calib_dt_filename);
  ...
  nh.param("init_lidar_inertial_calibration_result_filename", params.init_lidar_inertial_calibration_result_filename, params.init_lidar_inertial_calibration_result_filename);

  std::ifstream initial_calib(params.init_lidar_inertial_calibration_result_filename);
  std::string word;
  int i = 0;
  int j = 0;
  ...
  nh.param("lidar_inertial_calibration_result_filename", params.lidar_inertial_calibration_result_filename, params.lidar_inertial_calibration_result_filename);
