...
#include <imu_packet/ImuPacket.h>
...
typedef message_filters::sync_policies::ApproximateTime<imu_packet::ImuPacket, geometry_msgs::PoseStamped> SyncPolicy;
...
private:
  ros::NodeHandle nh;
  message_filters::Subscriber<imu_packet::ImuPacket> * imupacket_sub;
...
public:
  ...
  {
    nh = n;
    imupacket_sub = new message_filters::Subscriber<imu_packet::ImuPacket>(nh, "/imu_packet", 1);
  ...
  void callback(const imu_packet::ImuPacket::ConstPtr & imupacket_msg, const geometry_msgs::PoseStamped ::ConstPtr & pose_msg)
  {
