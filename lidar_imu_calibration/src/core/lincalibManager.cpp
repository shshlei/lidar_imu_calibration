...
lin_estimator::lincalibManager::lincalibManager(lincalibManagerOptions & params_)
{
  ...
  LOdom = std::make_shared<lin_core::LidarOdometry>(params.ndtResolution, params.lidar_odometry_trajectory_filename, params.downSampleForMapping);
  //    LOdom = LidarOdometry(params.ndtResolution, params.lidar_odometry_trajectory_filename, false);
}
